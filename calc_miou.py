...
def score(pre_IoU, base_IoU):
    ...
    for pre, base in zip(pre_IoU, base_IoU):
        ...
        score_class_list.append(score_class)
        score += score_class
    score_class_list.append(score)
    return score_class_list
...
if __name__ == "__main__":
    ...
    score = 0
    ####计算class IoU分数####
    pred_dir = '/root/test_predictions'
    base_dir = '/root/baseline_predictions'
    gt_dir = '/root/test_ground_truths'
    improvement_threshold = 0.06
